...
namespace Core {
    public static class Static {
        ...
        public const string VersionStr = "0.0.9";
        public static readonly Version Version = new Version(0, 0, 9);
        ...
        public static readonly HashSet<string> DataStoreBlacklist = new HashSet<string>();
        #endregion
